...
Run "tanzu app workload create tanzu-sample-flask -f workload.yaml"

U

After deploying or completing the instructions above to fork the repo, follow these steps:
